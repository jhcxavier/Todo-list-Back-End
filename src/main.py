...
# @app.route('/person/<int:todo_id>', methods=['PUT', 'GET', 'DELETE'])
# def get_single_person(todo_id):
#     """
#     Single person
#     """
...
#         if "username" in body:
#             todo11.username = body["username"]
#         if "email" in body:
#             todo11.email = body["email"]
#         db.session.commit()
...
#         todo11 = Person.query.get(todo_id)
#         if todo11 is None:
#             raise APIException('User not found', status_code=404)
